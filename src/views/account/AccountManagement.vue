  ...
  methods: {
    ...
    async addUser() {
      try {
        ...
        this.email = this.master_user.data[0].email;
        this.username = this.master_user.data[0].username;
        this.password = this.master_user.data[0].password;
        this.group = parseInt(this.master_user.data[0].group);
